...
void AMyProjectPlayerController::SetupInputComponent()
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(InputComponent))
	{
		...
		EnhancedInputComponent->BindAction(SetDestinationClickAction, ETriggerEvent::Started, this, &AMyProjectPlayerController::Attack);
...
{
	auto myChar = Cast<AMyProjectCharacter>(GetPawn());
	if (myChar != nullptr)
	{
		myChar->ServerRPC_Attack(myChar->GetActorForwardVector());
	}
}
